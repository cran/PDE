...
6. **Number of sentences before and after**: When 0 is chosen, only the sentence with
...
7. **Evaluate abbreviations?**: If "yes" was chosen, all abbreviations that were used in the
